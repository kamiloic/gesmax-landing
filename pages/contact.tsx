...
const Contact: NextPage<Props> = ({ data }) => {
  ...
  const title = isFr ? "Contactez-nous, Gesmax By Bogital" : "Contact, Gesmax By Bogital"
  const desc = isFr ? "Contactez-nous, Gesmax By Bogital" : "Contact, Gesmax By Bogital"
  const subtitle = ""
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
              <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                ...
                <form className="mt-6" action="https://formsubmit.co/af08c8ea8870e60d69f31868a7acb70e" method="POST">
                  ...
                  <input type="hidden" name="_next" value="https://gesmax.net"></input>
