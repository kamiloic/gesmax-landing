    ...
    return (
        <footer className="pt-8 text-gray-800">
            ...
            <div className="flex flex-row items-center justify-between mb-4    px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <p className="text-xs text-center pt-4 md:pt-2">Powered with ❤️ by <a href="https://bogital.com" className="text-primary" target="_blank" rel="noreferrer">Bogital</a></p>
